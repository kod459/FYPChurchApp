    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if ((TempData["ErrorEmail"] == null))
                {
                    if (!checkEmail)
                    {
                        ...
                        try
                        {
                            WebSecurity.CreateUserAndAccount(model.UserName, model.Password, new { Email = model.Email, model.Name, model.PhoneNumber });
                            Roles.AddUserToRole(model.UserName, "Lay User");
        ...
        public ActionResult LostPassword(LostPasswordModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    string resetLink = "Your password reset link: "
                        + Url.Action("ResetPassword", "Account", new { rt = token }, "http");

                    // Email stuff
                    string subject = "Reset your password for Photocopier Information Management Services (PIMS)";
                    string body = "You link: " + resetLink;
                    string from = "MeterReadings@welfare.ie";
        ...
        public ActionResult ResetPassword(ResetPasswordModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    ViewBag.Message = "Something went wrong! Please try again or contact the MSDU for assistance.";
                }
            }
            return View(model);
        }
        ...
        //    SelectList list = new SelectList(Roles.GetRolesForUser(users.ToString()));
        //    ViewBag.RolesAndUsers = list;
